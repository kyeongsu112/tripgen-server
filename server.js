...
// 2. 관리자 클라이언트 (회원 완전 삭제 및 관리자 권한 작업용)
...
// ✨ [수정됨] 환경변수에서 관리자 이메일 가져오기 (하드코딩 제거)
...
// 3. 삭제: 관리자(ADMIN_EMAIL) 또는 작성자 본인만 가능
